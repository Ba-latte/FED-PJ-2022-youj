    ...
    const goSlide = (seq)=>{
        ...
        if(seq){
            ...
            setTimeout(()=>{
                ...
                // (2-3)밖의 첫번째 li를 잘라서 맨뒤로 보내면서 동시에 top값을 0으로 바꾸는걸...이렇게 움직이는 걸 굳이 보여줄 필요 없기 때문에 트랜지션을 없애주면 됨
        ...
        // 2-1-2. 왼쪽 버튼 클릭시 : seq===0
            ...
            // (3) 그 후 top값을 0으로 애니메이션하여 슬라이드가 왼쪽에서 들어온다.
            // slide.style.top = "0";
            // : 이렇게 해두면 너무 빛으 속도로...해서.. 변함이 없어보여;; 그래서 코딩공간을 구분하면! 그러면 조금이라도 시차가 생김!! -> 이때 사용하는 게 setTimeout이래!
            // 📢📢쌤왈: 동일 속성인 top가 같은 코딩 처리 공간에서 동시에 있으므로, 이것을 분리해야 효과가 있다! 이때 쓰는게 setTimeout임!!
            setTimeout(()=>{
                slide.style.top = "0";
                slide.style.transition = "top .4s ease-in-out";
            }, 0); ///////////////////// 타임 아웃 ////////////////////////////
