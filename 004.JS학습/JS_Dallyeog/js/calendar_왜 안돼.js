    ...
    const initDallyeok = ()=>{
        ...
        if(thisFirst.getDay() !== 0){
            ...
            for(let i = 0; i < thisFirst.getDay(); i++){
                // cg(i);
                // 반복 횟수만큼 배열 앞쪽에 추가한다
                // 전달 마지막 날짜부터! -> prevLast 변수에서 getDate하면 됨...! + 전달 클래스는 bm으로 구분하기
        ...
        // (3) 다음달 나머지 칸 삽입하기 : 넉넉하게 2주치를 추가로 잡으려고 함! (굳이 어렵게 계산하지 말고! 나중에 화면에서는 그냥 필요 부분만 잘라서 쓸 거니까!) + 다음달 클래스는 am으로 구분하기
